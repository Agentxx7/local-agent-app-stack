...
required_directories=(
  ...
  "skills/production-path-verification"
...
required_files=(
  ...
  "guardrails/command-safety-policy.md"
  ...
  "skills/safe-command-execution/SKILL.md"
  ...
  "templates/command-approval-template.md"
